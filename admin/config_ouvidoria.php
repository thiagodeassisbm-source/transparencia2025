...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['config'])) {
    ...
    registrar_log($pdo, 'EDIÇÃO', 'configuracoes', "Atualizou as configurações da Ouvidoria (abas) para a prefeitura ID: $pref_id");
        ...
        <div class="col-12">
            ...
            <ul class="nav nav-pills mb-4 bg-white p-2 rounded-4 shadow-sm d-inline-flex flex-wrap" id="ouvidoriaTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active rounded-3 fw-bold px-3 px-md-4" id="atendimento-tab" data-bs-toggle="pill" data-bs-target="#atendimento" type="button" role="tab">1. Atendimento</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-3 fw-bold px-3 px-md-4" id="manifestar-tab" data-bs-toggle="pill" data-bs-target="#manifestar" type="button" role="tab">2. Manifestar</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-3 fw-bold px-3 px-md-4" id="consultar-tab" data-bs-toggle="pill" data-bs-target="#consultar" type="button" role="tab">3. Consultar</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-3 fw-bold px-3 px-md-4" id="relatorio-tab" data-bs-toggle="pill" data-bs-target="#relatorio" type="button" role="tab">4. Relatório</button>
                </li>
            </ul>
            ...
            <form method="POST" action="config_ouvidoria.php">
                <div class="tab-content" id="ouvidoriaTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="atendimento" role="tabpanel">
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                            <div class="card-header bg-white py-3 border-bottom-0">
                                <h6 class="mb-0 fw-bold text-dark"><i class="bi bi-headset text-primary me-2"></i>Card Atendimento e texto da página</h6>
                            </div>
                    ...
                    <div class="tab-pane fade" id="manifestar" role="tabpanel">
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                            <div class="card-header bg-white py-3 border-bottom-0">
                                <h6 class="mb-0 fw-bold text-dark"><i class="bi bi-pencil-square text-success me-2"></i>Card Manifestar</h6>
                            </div>
                            <div class="card-body p-4 bg-light bg-opacity-10">
                                <div class="row g-4">
                                    <div class="col-12">
                                        <label class="form-label fw-bold small text-muted text-uppercase">Texto opcional (acima dos botões de tipo de manifestação)</label>
                                        <textarea class="form-control border-0 shadow-sm p-3 rounded-4" name="config[ouvidoria_manifestar_descricao]" rows="4" placeholder="Deixe em branco para não exibir texto extra no card."><?php echo htmlspecialchars($config_atuais['ouvidoria_manifestar_descricao']); ?></textarea>
                                        <p class="text-muted small mt-2 mb-0">Os atalhos (Sugestão, Elogio, etc.) são fixos no sistema.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="consultar" role="tabpanel">
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                            <div class="card-header bg-white py-3 border-bottom-0">
                                <h6 class="mb-0 fw-bold text-dark"><i class="bi bi-search text-info me-2"></i>Card Consultar protocolo</h6>
                            </div>
                            <div class="card-body p-4 bg-light bg-opacity-10">
                                <div class="row g-4">
                                    <div class="col-12">
                    ...
                    <div class="tab-pane fade" id="relatorio" role="tabpanel">
                        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                            <div class="card-header bg-white py-3 border-bottom-0">
                                <h6 class="mb-0 fw-bold text-dark"><i class="bi bi-bar-chart-fill text-dark me-2"></i>Card Relatório em tempo real</h6>
                            </div>
                            <div class="card-body p-4 bg-light bg-opacity-10">
                                <div class="row g-4">
                                    <div class="col-12">
                                        <label class="form-label fw-bold small text-muted text-uppercase">Texto opcional (acima das barras de estatística)</label>
                                        <textarea class="form-control border-0 shadow-sm p-3 rounded-4" name="config[ouvidoria_relatorio_descricao]" rows="3" placeholder="Deixe em branco para exibir apenas as barras."><?php echo htmlspecialchars($config_atuais['ouvidoria_relatorio_descricao']); ?></textarea>
                                        <p class="text-muted small mt-2 mb-0">Os totais são calculados automaticamente a partir das manifestações registradas.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
