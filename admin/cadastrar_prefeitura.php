                        ...
                        <div class="col-12 mt-2">
                            <div class="alert alert-light border border-primary-subtle rounded-3 p-3 shadow-sm">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <p class="mb-1 small"><strong>Passo 2: No nosso Servidor</strong></p>
                                        <ul class="mb-0 small text-muted ps-3">
                                            <li>Adicione este domínio como um <strong>Alias</strong> ou <strong>Domínio Adicional</strong> no painel Hostinger para que o servidor aceite a conexão.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
