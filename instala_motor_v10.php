<?php
/**
 * INSTALADOR DE MOTOR DE CLONE À PROVA DE FALHAS (V10)
 */

$target = __DIR__ . '/admin/functions_demo.php';
...
if (@file_put_contents($target, $code)) {
    echo "✅ NOVO MOTOR DE CLONAGEM SUPER RESILIENTE INJETADO COM SUCESSO!\n";
    echo "Pode apagar a prefeitura 'saopaulo' e tentar cadastrar novamente.";
} else {
    echo "❌ Erro ao modificar o arquivo, verifique as permissões de gravação na pasta admin.";
}
